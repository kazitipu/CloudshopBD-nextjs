  ...
  return (
    <div className="my-account-content account-address">
      <div className="text-center widget-inner-address">
        ...
        >
          <div className="title">
            {selectedAddress ? "Update" : "Add new"} address
          </div>
          ...
          <div className="box-field text-start">
            <div className="box-checkbox fieldset-radio d-flex align-items-center gap-8">
              ...
              />
              <label htmlFor="defaultShipping" className="text_black-2 fw-4">
          ...
          <div className="d-flex align-items-center justify-content-center gap-20">
            <button
              ...
              onClick={async () => {
                ...
                if (
                  ...
                  setLoader(true);
                  await updateUserAddressRedux(currentUser2, {
                    ...state,
                    id:
            ...
            >
              {loader ? (
                <ClipLoader loading={loader} size={18} color="white" />
              ) : selectedAddress ? (
                "Updated Address"
              ) : (
                "Add Address"
        ...
        {currentUser2 &&
          currentUser2.address &&
          currentUser2.address.length > 0 &&
          currentUser2.address.map((shippingAddress) => (
            <div
              style={{
                display: "flex",
                flexDirection: "row",
                ...
                border: shippingAddress.defaultShipping
                  ? "1px solid #ff99af"
                  : "1px solid gainsboro",
                borderRadius: 5,
                marginTop: 10,
              ...
              onClick={() => {
                if (!shippingAddress.defaultShipping) {
                  updateShippingAddressRedux(currentUser2, {
                    ...shippingAddress,
                ...
                >
                  <div>
                    <i
                      ...
                      style={{ fontSize: 30, color: "#ec345b" }}
                    ></i>
                    <div
                      style={{
                        backgroundColor:
              ...
              >
                <button
                  ...
                  onClick={(event) => {
                    ...
                    setState({
                      ...
                      defaultShipping: shippingAddress.defaultShipping,
                    });
                ...
                {!shippingAddress.defaultShipping && (
                  <button
                    ...
                    onClick={(event) => {
                      event.stopPropagation();
                      deleteAddressRedux(currentUser2, shippingAddress);
